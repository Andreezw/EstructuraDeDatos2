...
@FacesConverter(value = "barcoConverter")
public class BarcoConverter implements Converter {

    @Inject
    private BarcoFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Barco) {
            ...
            return getStringKey(o.getIdBarco());
        } else {
